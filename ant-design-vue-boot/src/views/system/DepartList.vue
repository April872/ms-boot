  ...
  <a-row :gutter="10">
    <a-col :md="12" :sm="24">
      <a-card :bordered="false">
        ...
        <a-row style="margin-left: 14px">
          <a-button @click="handleAdd(1)" type="primary">添加一级机构</a-button>
          <a-button @click="handleAdd(2)" type="primary">添加下级机构</a-button>
        ...
        <div style="background: #fff;padding-left:16px;height: 100%; margin-top: 5px">
          ...
          <a-input-search @search="onSearch" style="width:100%;margin-top: 10px" placeholder="请输入机构或部门名称" />
          <!-- 树-->
          <a-col :md="10" :sm="24">
            <template>
              <a-dropdown :trigger="[this.dropTrigger]" @visibleChange="dropStatus">
                <span style="user-select: none">
                  ...
                  >
                    <!-- 添加机构标识的图标 -->
                    <a-icon type="appstore" theme="twoTone" slot="org" />
                    <a-icon type="profile" slot="dep" />
                  </a-tree>
                </span>
                <!--新增右键点击事件,和增加添加和删除功能-->
                <a-menu slot="overlay">
                  ...
                  <a-menu-item key="2">
                    <a-popconfirm title="确定要删除吗?" @confirm="() => handleDelete()"><a>删除</a></a-popconfirm>
                  </a-menu-item>
    ...
    <a-col :md="12" :sm="24">
      <a-tabs defaultActiveKey="1">
        <a-tab-pane tab="基本信息" key="1">
          <a-card :bordered="false">
            <a-form :form="form">
              ...
              <a-form-item :labelCol="labelCol" :wrapperCol="wrapperCol" label="排序"><a-input-number v-decorator="['departOrder', { initialValue: 0 }]" /></a-form-item>
              ...
              <a-form-item :labelCol="labelCol" :wrapperCol="wrapperCol" label="备注">
                <a-textarea placeholder="请输入备注" autosize  v-decorator="['memo', { initialValue: '' }]" />
              </a-form-item>
            </a-form>
        ...
        <a-tab-pane tab="部门权限" key="2" forceRender><depart-auth-modal ref="DepartAuthModal" /></a-tab-pane>
      </a-tabs>
    </a-col>
