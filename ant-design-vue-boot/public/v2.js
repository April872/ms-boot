! function() {
  ...
  var f = {
    ...
    h = (c(function(e) {
      for (var t = {}, n = e && -1 !== e.indexOf("?") && e.split("?")[1] || window.location.search.substring(1), r =
          n.split("&"), o = 0; o < r.length; o++) {
        var i = r[o].split("=");
  ...
  Promise.prototype.then = function(e) {
    ...
    return "rejected" === this.state && e(this.reason), "pending" === this.state && this.onRejectAsyncCallbacks.push(
      e), this
  ...
  var y = function() {
      ...
      var o = !1,
        ...
        f = function(e) {
          return l(e) ? c(e) : g.getConfig(e).then(function(t) {
            return t.code !== m.Success ? (s(w[t.msg] || t.msg), Promise.reject(t.code)) : (t.type !== e.type && (t
              .mode = t.type, t.type = e.type), a(e, t), l(e) ? c(e) : Promise.resolve())
          })
        },
        d = function(e, t) {
        ...
        b = function C(e) {
          ...
          return new Promise(function(o) {
            ...
            var i = function() {
              r.readyState && "loaded" !== r.readyState && "complete" !== r.readyState || (o(), r.loaded = !0, r.onload =
                null, r.onreadystatechange = null)
            };
            a(r, {
              async: !0,
              charset: "utf-8",
          ...
          return b(r).then(function() {
            ...
            return r.vaptcha.resetCaptcha = function(e, t) {
              a(n, t), T({
                ...
                r.destroy(), r.options = e.options, r.vaptcha = e.vaptcha, e.render(), "character" === n.mode &&
                  ["click", "float", "popup"].includes(n.type) && e.vaptcha.dtClickCb({
        ...
        A = function(e) {
          o = !0, e.https = !0, e.protocol = "https://", y.setConfig(e), !["embed", "popup", "invisible"].includes(e.type) &&
            (e.type = "popup"), i() < 9 && b(d(e, e.canvas_path));
          var t = new v(e);
          if (t.addValidateRules({
              elementOrSelector: function(t, o) {
                if ("String" === u(e.container) && (e.container = document.querySelector(e.container)), n(e.container) &&
                  r(e.container[0]) && (e.container = e.container[0]), !r(e.container)) return o
              }
            }), t.add("vid", "required", "please configure vid"), "invisible" !== e.type && t.add("container",
              "elementOrSelector", "please configure container with element or selector"), t.validate()) return f(e).then(
            function() {
    ...
    j = function() {
      ...
      return function() {
        for (var t = document.querySelectorAll("[data-vid]"), o = document.querySelectorAll("[data-config]"), i = 0; i <
          o.length; i++) {
          var a = e(o[i]);
          r(o[i], a)
        }
