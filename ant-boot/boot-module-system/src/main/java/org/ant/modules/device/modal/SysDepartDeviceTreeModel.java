package org.ant.modules.device.modal;
 ...
 * @Since 2019-01-22 
 */
public class SysDepartDeviceTreeModel implements Serializable{
    ...
    private List<SysDepartDeviceTreeModel> children = new ArrayList<>();
     ...
     * @param sysDepart
     */
	public SysDepartDeviceTreeModel(SysDepart sysDepart) {
    ...
    public List<SysDepartDeviceTreeModel> getChildren() {
        return children;
    }

    public void setChildren(List<SysDepartDeviceTreeModel> children) {
        if (children==null){
            this.isLeaf=true;
        }
    ...
    public SysDepartDeviceTreeModel() { }
    ...
    public boolean equals(Object o) {
        ...
        SysDepartDeviceTreeModel model = (SysDepartDeviceTreeModel) o;
